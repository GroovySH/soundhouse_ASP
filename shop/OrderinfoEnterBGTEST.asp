...
//			}
//			if (document.f_data.i_loan_company.value == "オリコ"){
...
<!---- お支払い方法 -------------------->
        ...
        <tr class="honbun">
          <td>&nbsp;</td>
          <td align="left" valign="top">
            <input type="radio" name="payment_method" value="コンビニ支払"><b>コンビニ/郵便局支払</b>
<table class="honbun">
  <tr>
    <td width=30></td>
    <td><font color='#666666'>・ローソン、ファミリーマート、サークルK、サンクス、ヤマザキデイリーストア、ミニストップ、セイコーマート、郵便局ATM・ぱるる でお支払いただけます｡</font></td>
  </tr>
  <tr>
    <td width=30></td>
  ...
  <tr>
    ...
    <td><font color='#ff0000'>・後ほど、お見積書をご案内致しますので、こちらをご確認後にお振込み頂けます様お願い致します。</font></td>
		...
		<tr class='honbun'>
		  ...
		  ・クレジットカードは注文日に決済されます。在庫が無く、納期がかかる場合、商品をお届けする前に代金が引き落とされる事もあります。<br>　あらかじめご了承ください。<br>
		  ・クレジットカード決済を選択されたお客様は、NTTデータのカード決済サイト「CAFIS BlueGate」をご利用して頂きます。</font></td>
		</tr>
        ...
        <tr class="honbun">
          ...
          <td align="left" valign="top">
            ...
            <input type="radio" name="loan_apply_fl" value="Y">オンラインでローンを申し込む。　(セントラルファイナンス)
            <input type="hidden" name="loan_company" value="セントラル">
<!-- 
            <img src="images/blank.gif" alt="" width="40" height="20" align="left">
            <input type="radio" name="loan_company" value="セントラル" checked>セントラルファイナンス　
           <input type="radio" name="loan_company" value="オリコ">オリコ（オリエントコーポレーション) -->
          </td>
        </tr>
        <tr class="honbun">
          <td>&nbsp;</td>
