...
'vSQL = vSQL & "    WHEN '獲得' THEN 1 "
'vSQL = vSQL & "    ELSE 9 END "
'vSQL = vSQL & "    AS kubun_no, "
'vSQL = vSQL & "  T1.ポイント区分 AS ポイント利用獲得,"
'vSQL = vSQL & "  T1.ポイント日付 AS ポイント獲得日,"
'vSQL = vSQL & "  SUM(T1.ポイント) AS ポイント"
'vSQL = vSQL & " FROM"
'vSQL = vSQL & "  " & gLinkServer & "ポイント明細 T1 WITH (NOLOCK)"
'vSQL = vSQL & "  LEFT JOIN " & gLinkServer & "受注 T2 WITH (NOLOCK)"
